...
WHATS_NEW: list[tuple[str, list[str]]] = [
    ("1.4.1", [
        "<b>사용법 가이드를 이 창에서 바로</b> 열 수 있습니다 — 아래"
        " <b>[사용법 가이드 보기]</b> 버튼을 누르세요."
        " (설정 → 사용법 가이드 다시 보기에도 있습니다)",
        "메모를 모두 휴지통에 넣어둔 채 업데이트하면 이 안내가 뜨지 않던 문제를"
        " 고쳤습니다.",
    ]),
    ("1.4.0", [
        "<b>사용법 가이드가 생겼습니다</b> — 설치 후 첫 실행에 말풍선으로 안내합니다."
        " 언제든 <b>설정 → 사용법 가이드 다시 보기</b>로 볼 수 있어요.",
        "<b>바 하단이 단순해졌습니다</b> — 설정 아이콘을 뺐습니다."
        " 설정은 <b>트레이 아이콘 우클릭</b>이나 <b>바 우클릭</b> 메뉴에 있고,"
        " 휴지통 아이콘은 휴지통에 메모가 있을 때만 나타납니다.",
        "<b>삭제가 한 번에</b> — 확인 창 없이 휴지통으로 갑니다."
        " 잘못 지웠으면 그때 뜨는 <b>‘되돌리기’</b>를 누르세요."
        " 탭을 고른 뒤 <b>Delete</b> 키로도 지울 수 있습니다.",
        "새 메모에 입력한 글자가 설정한 글꼴·크기와 다르게 찍히던 문제를 고쳤습니다.",
    ]),
    ("1.3.0", [
